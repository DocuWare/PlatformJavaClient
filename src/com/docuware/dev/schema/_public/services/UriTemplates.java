 ...
 * 
 * <p>Java-Klasse f�r UriTemplateDescriptions complex type.
 * 
...
@XmlRootElement(name = "UriTemplates")
public class UriTemplates        {

    @XmlElement(name = "Template")
    protected List<UriTemplate> templates;
     ...
     * 
     */
    public List<UriTemplate> getTemplates() {
        if (templates == null) {
            templates = new ArrayList<UriTemplate>();
        }
