...
@XmlRootElement(name = "CFSStatistic")
public class CFSStatistic       {

    @XmlElement(name = "StatisticSpecific", required = true)
    protected List<CFSStatisticSpecific> statisticSpecifics;
    ...
    /**
     * Gets the value of the statisticSpecifics property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statisticSpecifics property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatisticSpecifics().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CFSStatisticSpecific> getStatisticSpecifics() {
        if (statisticSpecifics == null) {
            statisticSpecifics = new ArrayList<CFSStatisticSpecific>();
        }
        return this.statisticSpecifics;
    }
