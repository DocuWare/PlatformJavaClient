...
@XmlRootElement(name = "StampFormFields")
public class StampFormFields     {

    @XmlElement(name = "Field")
    protected List<FormFieldValue> fields;
     ...
     * 
     */
    public List<FormFieldValue> getFields() {
        if (fields == null) {
            fields = new ArrayList<FormFieldValue>();
        }
        return this.fields;
    }
